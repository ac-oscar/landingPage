...
export default function Main() {
    ...
    return (
        <main className="container mx-auto px-px">
            ...
            <Section sectionId="metodos_de_pago" className="px-4 mt-10 flex justify-center items-center flex-col">
                <Section__Header className="text-5xl font-semibold">MÉTODOS DE PAGO</Section__Header>
                <Section__Content>
                    <p className="my-2.5">
